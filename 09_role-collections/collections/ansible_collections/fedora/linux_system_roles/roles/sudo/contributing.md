...
[Github Issues](https://github.com/fedora.linux_system_roles.sudo/issues).
Issues labeled with
[**help wanted**](https://github.com/fedora.linux_system_roles.sudo/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)
are likely to be suitable for new contributors!

**Code** is managed on [Github](https://github.com/fedora.linux_system_roles.sudo), using
...
For example, see [meta](https://github.com/fedora.linux_system_roles.sudo/blob/main/meta/main.yml)
