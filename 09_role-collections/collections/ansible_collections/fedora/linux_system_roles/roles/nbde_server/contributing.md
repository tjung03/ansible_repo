# Contributing to the nbde_server Linux System Role
...
[Github Issues](https://github.com/fedora.linux_system_roles.nbde_server/issues).
Issues labeled with
[**help wanted**](https://github.com/fedora.linux_system_roles.nbde_server/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)
are likely to be suitable for new contributors!

**Code** is managed on [Github](https://github.com/fedora.linux_system_roles.nbde_server), using
...
For example, see [meta](https://github.com/fedora.linux_system_roles.nbde_server/blob/main/meta/main.yml)
